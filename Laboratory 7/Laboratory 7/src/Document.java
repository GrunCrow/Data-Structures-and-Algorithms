...
class Document implements IWithName
{
    ...
    public int hashCode()
    {
        ...
        /* for abcd -> a in ascii table = 97
         * a = 97, there is a next letter -> * element of sequence (7) + next char val
         * ab = 97 * 7 + 98
         * abc = (97 * 7 + 98)* 11 + 99
         * abcd ((97 * 7 + 98)* 11 + 99) * 13 + 100
         * */
   
        int result = name.charAt(0); //value first char
        
        for (int i = 1; i < name.length(); i++) { //for each extra letter
